-- Corregir las funciones con search_path mutable usando CASCADE
DROP FUNCTION public.update_professional_ranking CASCADE;
...
-- Recrear el trigger que se eliminó con CASCADE
